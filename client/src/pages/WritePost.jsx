...
const WritePost = () => {
  ...
  function handleImgUpload() {
    ...
    if (!fileToUpload) { // If file is not empty
      setErrorMessage("Please upload an image to post.");
      return;
    }

    if (!coordinates) { // If coordinates were not selected
      setErrorMessage("Please select a location on the map of the location of your image.");
      return;
    }
